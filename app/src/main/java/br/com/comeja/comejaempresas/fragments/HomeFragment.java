...
import br.com.comeja.comejaempresas.adapter.ConfiguracoesAdapter;
...
public class HomeFragment extends Fragment implements RecyclerViewOnClickListenerHack {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        txtHome = (RobotoTextView) view.findViewById(R.id.txtHome);
        txtHome.setText("Bem Vindo ao ComeJá! \n" + ((MainActivity) getActivity()).getEmpresaLogada().getNomeFantasiaPessoa());
        ...
        for(int i = 0; i<mList.size();i++){
                ...
                if (MainActivity.versao< mList.get(i).getVersaoAppIphone()) {
                    mensagem=true;
                }
        ...
        if(mensagem){
            ...
            build.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    final String appPackageName = "br.com.comeja.comejaempresas";
                    try {
